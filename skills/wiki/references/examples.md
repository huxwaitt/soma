...
```
vault_wiki_write(record_path="Soma/Emails/2026-08-22 Budget Q3.md", created_by="soma/0.4.2", pages=[
...
```
vault_wiki_write(record_path="Soma/Meetings/2026-08-25 1300 Weekly supplier sync.md", created_by="soma/0.4.2", pages=[
...
```
vault_wiki_write(record_path="Soma/Emails/2026-08-19 Budget timing.md", created_by="soma/0.4.2", pages=[
  {"path": "Soma/Wiki/Topics/q3-budget.md", "ops": [
...
```
vault_wiki_keep(action="review", review_action="resolve", item="1", resolution_ops=[{"op": "confirm", "id": "m4rt", "src": "user"}], created_by="soma/0.4.2")
```
