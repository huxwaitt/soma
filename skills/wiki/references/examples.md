...
`/soma:save budget q3 jane` on 2026-08-22 wrote `Soma/Emails/2026-08-22 Budget Q3.md` (`internet_message_id: <7f3a9c@example.com>`, `received: 2026-08-22T09:14:00+02:00`, sender `jane.doe@example.com`, summary "Jane asks for the final Q3 numbers by Friday so she can close the forecast."). `body_trimmed`:
...
```json
{"pages": [
  {"path": "Soma/Wiki/Topics/q3-budget.md", "line": "- [[Wiki/Topics/q3-budget|Q3 budget]] · active · 2026-08-20 — Q3 numbers collected by Jane; forecast closes early September.", "score": 4, "why": ["alias"]},
  {"path": "Soma/Wiki/People/Jane Doe.md", "line": "- [[Wiki/People/Jane Doe]] · Example GmbH · 2026-08-21 — Finance lead; owns the quarterly forecast.", "score": 3, "why": ["address"]}],
 "candidates": []}
```
...
```
vault_wiki_read(path="Soma/Wiki/Topics/q3-budget.md", sections=["lead","facts"])
```

```json
{"path": "Soma/Wiki/Topics/q3-budget.md", "title": "Q3 budget",
...
`vault_wiki_read("Soma/Wiki/People/Jane Doe.md", sections=["lead","facts"])` → facts `[{"id": "a8p1", "text": "Owns the quarterly forecast", ...}]`.
...
```
vault_wiki_write(record_path="Soma/Emails/2026-08-22 Budget Q3.md", created_by="soma/0.4.1", pages=[
  {"path": "Soma/Wiki/Topics/q3-budget.md", "ops": [
  ...
  {"path": "Soma/Wiki/People/Jane Doe.md", "ops": [
...
{"record": "[[Emails/2026-08-22 Budget Q3]]",
 "pages": [
  {"path": "Soma/Wiki/Topics/q3-budget.md", "written": true,
  ...
  {"path": "Soma/Wiki/People/Jane Doe.md", "written": true,
...
`/soma:notes supplier sync` on 2026-08-25 wrote `Soma/Meetings/2026-08-25 1300 Weekly supplier sync.md` (`occurrence_key: 0400A1…|2026-08-25T13:00:00+02:00`, attendees Jane Doe and Tom Lee of `acme-parts.com`). The notes:
...
2. `vault_wiki_read("Soma/Wiki/Topics/acme-supplier-contract.md", sections=["lead","facts"])` →
...
`vault_wiki_read("Soma/Wiki/People/Tom Lee.md", …)` → facts `[{"id": "r1ke", "text": "Handles purchase orders and delivery scheduling at ACME Parts", ...}]`; the org page holds nothing about terms.
...
```
vault_wiki_write(record_path="Soma/Meetings/2026-08-25 1300 Weekly supplier sync.md", created_by="soma/0.4.1", pages=[
  ...
  {"path": "Soma/Wiki/People/Jane Doe.md", "ops": []},
  {"path": "Soma/Wiki/Orgs/acme-parts.md", "ops": []}])
```
...
The save writes `Soma/Emails/2026-08-19 Budget timing.md`. Ingest:
...
```
vault_wiki_write(record_path="Soma/Emails/2026-08-19 Budget timing.md", created_by="soma/0.4.1", pages=[
  {"path": "Soma/Wiki/Topics/q3-budget.md", "ops": [
...
{"record": "[[Emails/2026-08-19 Budget timing]]",
 "pages": [{"path": "Soma/Wiki/Topics/q3-budget.md", "written": true, "applied": [{"op": "contest", "id": "m4rt", "result": "review"}], "refused": [], "record_added": true, "history_added": 0, "sizes": {"...": "..."}}],
 "candidate": {"...": "..."}}
```
...
```
vault_wiki_keep(action="review", review_action="resolve", item="1", resolution_ops=[{"op": "confirm", "id": "m4rt", "src": "user"}], created_by="soma/0.4.1")
```
...
Closing it later is `{"op": "done", "id": <the item's `o:` id>, "src": "user"}`, a new date `{"op": "reschedule", "id": …, "due": "2026-09-09", "src": …}`. `Soma/Follow-ups.md` is written from these lines and refuses rows.
