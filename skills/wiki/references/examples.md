...
```
vault_wiki_ingest(record_path="Administrator/Emails/2026-08-22 Budget Q3.md", created_by="administrator/0.2.0", pages=[
...
```
vault_wiki_ingest(record_path="Administrator/Meetings/2026-08-25 1300 Weekly supplier sync.md", created_by="administrator/0.2.0", pages=[
...
```
vault_wiki_ingest(record_path="Administrator/Emails/2026-08-19 Budget timing.md", created_by="administrator/0.2.0", pages=[
  {"path": "Administrator/Wiki/Topics/q3-budget.md", "ops": [
...
```
vault_wiki_review(action="resolve", item="1", resolution_ops=[{"op": "confirm", "id": "m4rt", "src": "user"}], created_by="administrator/0.2.0")
```
