...
```
vault_row(action="append", path="Soma/Time-blocks/<week>.md", section="Held",
...
`appended: false, reason: duplicate` = already answered, say nothing. Unanswered blocks stay unanswered; `/soma:weekly` counts them.
