...
2. `vault_status` if not done yet this session (anything missing → `vault_init(created_by="soma/0.4.1")`); `outlook_whoami(response_format="json")` once.
