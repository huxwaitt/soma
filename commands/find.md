---
description: Find one email or thread from a plain-language description — people, topic words, dates, attachment hints — and quote the line that answers it. One outlook_find call does the searching. Read-only; offers /administrator:save on the winner.
...
/administrator:find which email had the venue options for the offsite
```
