...
> Vault: `C:\Users\<you>\Documents\Vault` (name `Vault`). Created `Administrator/`, 9 folders, `Wiki/` (Wiki.md, Index, Log, Review, Questions.md, 5 page folders including `Decisions/`), `Follow-ups.md` (written from the wiki pages), `Preferences.md` (09:00–17:00, buffer 15, peak 09:00–12:00), `Priorities.md` and 5 views.
