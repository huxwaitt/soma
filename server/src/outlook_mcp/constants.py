...
# OlSaveAsType — second arg to Item.SaveAs
OL_SAVE_TXT = 0
OL_SAVE_MSG = 3
OL_SAVE_HTML = 5
OL_SAVE_MSG_UNICODE = 9

# fmt name -> (OlSaveAsType, file suffix)
SAVE_AS_MAP: dict[str, tuple[int, str]] = {
    "msg": (OL_SAVE_MSG_UNICODE, ".msg"),
    "txt": (OL_SAVE_TXT, ".txt"),
    "html": (OL_SAVE_HTML, ".html"),
}
